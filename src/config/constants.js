// ===== 배경 이미지 =====
export const IMAGE_SRC = "assets/images/002-1.jpg";

// ===== 오버레이 설정 =====
export const OVERLAYS = [
  { src: "assets/images/say1.png", show: "1.0%", left: "2.25vw", top: "14vh", bottom: "46.3vh" },
  { src: "assets/images/say2.png", show: "2.4%", left: "40vw", top: "34vh", bottom: "25vh" },
  { src: "assets/images/say3.png", show: "4.0%", left: "50vw", top: "9.2vh", bottom: "56.8vh" },
  { src: "assets/images/say4.png", show: "7.5%", left: "70vw", top: "20.4vh", bottom: "26vh" },
  { src: "assets/images/say5.png", show: "18%", left: "36vw", top: "7.4vh", bottom: "63vh" },
  { src: "assets/images/say6.png", show: "32%", left: "60vw", top: "0vh", bottom: "51vh" },
];
...
// ===== GNB =====
export const LOGO_SRC = "assets/images/logo.png";
...
// ===== 파일 경로 =====
export const BG_IMG_SRC  = "assets/images/background1.png";
export const BG0_IMG_SRC = "assets/images/background0.png";
export const BG0_PANEL_WIDTH = 2820;

// (sample.mp4 없음 → 비활성화 또는 직접 추가)
...
export const PNG_SPRITES = [
  "assets/pngs/01-2.png",
  "assets/pngs/02-2.png",
  "assets/pngs/03.png",
  "assets/pngs/04.png",
  "assets/pngs/05-2.png",
];
